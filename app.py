    ...
    <body>
        ...
        <div class="card">
            ...
            <table>
                ...
                {top_ips_rows if top_ips_rows else "<tr><td colspan='2'>No data</td></tr>"}
            </table>
        </div>
        ...
        <div class="card">
            ...
            <table>
                ...
                {alerts_rows if alerts_rows else "<tr><td colspan='4'>No alerts generated</td></tr>"}
            </table>
        </div>
        ...
        <div class="card">
            ...
            <ul>
                <li>Enable rate limiting on authentication endpoints (e.g., /login).</li>
                <li>Block suspicious IPs after repeated failures (temporary + permanent bans).</li>
                <li>Use MFA and strong password policies to prevent credential stuffing.</li>
                <li>Monitor logs continuously and alert on anomalies.</li>
            </ul>
        </div>

        <p class="muted">Generated by ThreatLens AI</p>
    </body>
    </html>
    """
    return html
